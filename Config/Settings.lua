...
local function formatDurationChoice(durationFormat, value, fallbackUnit)
	if type(durationFormat) == "string" then
		return string.format(durationFormat, value)
	end
	return tostring(value) .. " " .. fallbackUnit
end
			...
			settings = {
				...
				},
				{
					...
					choices = {
						...
						{
							value = 15,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_MIN, 15, "min")
						},
						{
							value = 30,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_MIN, 30, "min")
						},
						{
							value = 45,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_MIN, 45, "min")
						},
						{
							value = 60,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS, 1, "hour")
						},
						{
							value = 120,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 2, "hours")
						},
						{
							value = 180,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 3, "hours")
						},
						{
							value = 240,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 4, "hours")
						},
						{
							value = 300,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 5, "hours")
						},
						{
							value = 360,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 6, "hours")
						},
						{
							value = 720,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 12, "hours")
						},
						{
							value = 1440,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_HOURS_P1 or _G.INT_SPELL_DURATION_HOURS, 24, "hours")
						},
					},
					onChange = function(settings, settingName, newValue)
				...
				},
				{
					...
					choices = {
						...
						{
							value = 2880,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_DAYS, 2, "days")
						},
						{
							value = 4320,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_DAYS, 3, "days")
						},
						{
							value = 10080,
							text = formatDurationChoice(_G.INT_SPELL_DURATION_DAYS, 7, "days")
						}
					},
					inventoryWindowUpdateOnChange = true,
				},
